...
<a href="https://joelvaneenwyk.github.io/spotify-exportify/"><img src="images/screenshot.png"/></a>

Export your Spotify playlists to [CSV](https://en.wikipedia.org/wiki/Comma-separated_values) by clicking on the link below:

[https://joelvaneenwyk.github.io/spotify-exportify/](https://joelvaneenwyk.github.io/spotify-exportify/)
...
1. Fire up [the app](https://joelvaneenwyk.github.io/spotify-exportify/)
2. Click 'Get Started'
...
<a href="https://joelvaneenwyk.github.io/spotify-exportify/"><img src="images/100668594-72be1600-335c-11eb-90d6-c9ae873e347d.png"/></a>
...
<a href="https://joelvaneenwyk.github.io/spotify-exportify/"><img src="https://user-images.githubusercontent.com/17737/100201109-eb0d7d00-2eff-11eb-993e-7ed955e2361c.gif"/></a>
...
- I've [gone to some lengths](https://github.com/joelvaneenwyk/spotify-exportify/pull/75) to try to eliminate errors resulting from excessively high usage of the Spotify API. Nonetheless, exporting data in bulk is a fairly request-intensive process, so please do try to use this tool responsibly. If you do require more throughput, please consider [creating your own Spotify application](https://github.com/joelvaneenwyk/spotify-exportify/issues/6#issuecomment-110793132) which you can use with Exportify directly.
...
1. Fork it ( <https://github.com/joelvaneenwyk/spotify-exportify/fork> )
